...
window.QUIZZES = {
  ...
  "hld-ai": {
    ...
    questions: [
      ...
      {
        q: "Retrieval-Augmented Generation (RAG) primarily fixes which problem?",
        options: ["Slow GPUs", "The model not knowing your private data and hallucinating", "Token cost", "Network latency"],
        answer: 1,
        explain: "RAG retrieves relevant chunks from your knowledge base at query time and grounds the prompt in them, so the model answers from supplied facts instead of guessing."
      },
      {
