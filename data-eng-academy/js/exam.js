...
(function () {
  ...
  var CARDS = [
    ...
    { front: "Small files problem", track: "storage", back: "A large number of tiny files forces excessive metadata lookups and task overhead, hurting read performance; compaction merges them into fewer, right-sized files." },
